    ...
    <div className="bg-white">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          <h2 className="text-2xl font-bold text-gray-900">Contact details needed</h2>
          <p className="mt-3 text-gray-600">
            Please provide the preferred contact email or form link to publish here.
          </p>
          <div className="mt-6 rounded-xl border border-blue-100 bg-blue-50 p-5 text-sm text-blue-900">
            Once you share the official contact method, we will add it immediately.
          </div>
        </div>
      </section>
    </div>
